...
const BottomNav: React.FC<BottomNavProps> = ({ items }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pointer-events-none px-4 pb-4">
            <div className="w-full glass-nav pointer-events-auto rounded-[32px] overflow-hidden shadow-2xl safe-bottom border-t-0 border border-white/20">
                <div className="flex justify-around items-center pt-2 relative h-20">
                    {navItems.map((item) => {
